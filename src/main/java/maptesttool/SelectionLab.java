...
public class SelectionLab {
    ...
    /**
     * This method connects to the shapefile; retrieves information about its
     * features; creates a
     * map frame to display the shapefile and adds a custom feature selection tool
     * to the toolbar of
     * the map frame.
     */
    public void displayShapefile(File file) throws Exception {
        ...
        /**
         * Finally, we display the map frame. When it is closed this application will
         * exit.
         */
    ...
    /**
     * This method is called by our feature selection tool when the user has clicked
     * on the map.
     *
    ...
    /**
     * Sets the display to paint selected features yellow and unselected features in
     * the default
     * style.
     *
    ...
    /**
     * Create a Style where features with given IDs are painted yellow, while others
     * are painted
